...
function handleServerMessage(message) {
  ...
  if (message.agent_response) {
    ...
    if (window.isTtsEnabled && message.agent_response) {
...
window.ttsDebounceTimer = null; // Debounce timer to prevent rapid TTS calls
...
function generateSpeech(text) {
  ...
  // Debounce rapid TTS calls (300ms delay)
  window.ttsDebounceTimer = setTimeout(() => {
